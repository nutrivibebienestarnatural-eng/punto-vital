...
const PRODUCTS = [
  ...
  {id:140,name:"Calcio Plus - Calcio + D3 (60 caps)",price:15290,cost:11496.24,desc:"Salud ósea y función muscular.",cat:"Vitaminas",barcode:"0714604213765",img:"/fotos/calcio-plus.jpg",stock:true},
  {id:27,name:"Centella Asiática (30 caps)",price:16390,cost:12323.31,desc:"Cicatrizante y anticelulitico natural.",cat:"Antiage & Piel",barcode:"0714604213574",img:"",stock:true},
  {id:141,name:"Cistina Action - Capilar (60 caps)",price:26950,cost:20263.16,desc:"Fortalece el cabello desde adentro.",cat:"Antiage & Piel",barcode:"0714604213789",img:"",stock:true},
  {id:28,name:"Citrato de Magnesio 400mg (60 caps)",price:16489,cost:12397.74,desc:"Relajante muscular y nervioso.",cat:"Magnesio",barcode:"0714604143062",img:"",stock:true},
  {id:29,name:"Citrato de Magnesio 400mg (60 comp)",price:15620,cost:11744.36,desc:"Relajante muscular y nervioso.",cat:"Magnesio",barcode:"0714604213420",img:"",stock:true},
  {id:30,name:"Citrato de Potasio 400mg (60 caps)",price:16390,cost:12323.31,desc:"Equilibrio electrolítico. Corazón y músculos.",cat:"Minerales",barcode:"0714604143093",img:"",stock:true},
  {id:47,name:"Clean F - Hongo Cándida (60 caps)",price:20130,cost:15135.34,desc:"Fórmula antifúngica natural.",cat:"Salud Intestinal",barcode:"0714604143215",img:"",stock:true},
  {id:31,name:"Coenzima Q10 300mg (60 caps)",price:41250,cost:31015.04,desc:"Energía celular y antioxidante cardioprotector.",cat:"Antioxidantes",barcode:"0714604143857",img:"",stock:true},
  {id:34,name:"Complex B - Complejo B (30 caps)",price:16390,cost:12323.31,desc:"Todas las vitaminas del grupo B en una fórmula.",cat:"Vitaminas",barcode:"0714604213239",img:"",stock:true},
  {id:69,name:"Creatina (90 caps)",price:17490,cost:13150.38,desc:"Creatina monohidratada. Fuerza y rendimiento.",cat:"Deportivo",barcode:"0714604143321",img:"",stock:true},
  {id:38,name:"Creatina Pura 100% (300 gr)",price:37950,cost:28533.83,desc:"Creatina monohidratada. Fuerza y rendimiento.",cat:"Deportivo",barcode:"0714604213444",img:"",stock:true},
  {id:40,name:"Cúrcuma Activada con Jengibre (60 caps)",price:17490,cost:13150.38,desc:"Antiinflamatorio natural potenciado con jengibre.",cat:"Antiinflamatorio",barcode:"0714604143161",img:"",stock:true},
  {id:41,name:"Cúrcuma Orgánica (60 caps)",price:17050,cost:12819.55,desc:"Cúrcuma 100% orgánica. Antiinflamatorio.",cat:"Antiinflamatorio",barcode:"0714604143178",img:"",stock:true},
  {id:44,name:"Elixir Bio-Regenerador (60 caps)",price:19250,cost:14473.68,desc:"Regeneración celular integral.",cat:"Longevidad",barcode:"0714604143192",img:"",stock:true},
  {id:46,name:"Fucus Plus (60 caps)",price:17490,cost:13150.38,desc:"Alga marina. Control de peso y función tiroidea.",cat:"Control de Peso",barcode:"0714604213628",img:"",stock:true},
  {id:147,name:"Full Men - Estimulante Natural (60 caps)",price:29150,cost:21917.29,desc:"Estimulante natural masculino. Energía y vitalidad.",cat:"Hormonal",barcode:"0714604213819",img:"",stock:true},
  {id:48,name:"Garcinia Cambogia (60 caps)",price:16390,cost:12323.31,desc:"Quemador de grasas natural. Saciedad.",cat:"Control de Peso",barcode:"0714604213321",img:"",stock:true},
  {id:49,name:"Ginkgo Biloba (60 caps)",price:17050,cost:12819.55,desc:"Mejora memoria, concentración y circulación cerebral.",cat:"Neurológico",barcode:"0714604213611",img:"",stock:true},
  {id:51,name:"Glicinato de Magnesio (60 comp)",price:16830,cost:12654.14,desc:"Magnesio quelatado para sueño y relajación.",cat:"Magnesio",barcode:"0714604213406",img:"/fotos/glicinato-magnesio-comp.jpg",stock:true},
  {id:50,name:"Glicinato de Magnesio 500mg (60 caps)",price:17490,cost:13150.38,desc:"Magnesio quelatado para sueño y relajación profunda.",cat:"Magnesio",barcode:"0714604143222",img:"/fotos/glicinato-magnesio-comp.jpg",stock:true},
  {id:52,name:"Gluconato de Zinc (60 caps)",price:17490,cost:13150.38,desc:"Zinc para sistema inmune, piel y fertilidad.",cat:"Minerales",barcode:"0714604213222",img:"",stock:true},
  {id:142,name:"Glutamina Micronizada 300gr",price:37290,cost:28037.59,desc:"Glutamina pura micronizada. Recuperación y salud intestinal.",cat:"Deportivo",barcode:"0714604213468",img:"",stock:true},
  {id:53,name:"Glutatión Antioxidante (60 caps)",price:31790,cost:23902.26,desc:"Rey de los antioxidantes. Detox hepático y celular.",cat:"Antioxidantes",barcode:"0714604143239",img:"",stock:true},
  {id:54,name:"Glutatión Antioxidante (60 comp)",price:30250,cost:22744.36,desc:"Rey de los antioxidantes. Detox hepático y celular.",cat:"Antioxidantes",barcode:"0714604213550",img:"",stock:true},
  {id:56,name:"Hiper T - Tiroides Control (60 caps)",price:26389,cost:19841.35,desc:"Soporte natural para tiroides hiperactiva.",cat:"Tiroides",barcode:"0714604213307",img:"",stock:true},
  {id:57,name:"Hipo T - Tiroides Control (60 caps)",price:26389,cost:19841.35,desc:"Soporte natural para tiroides hipoactiva.",cat:"Tiroides",barcode:"0714604213291",img:"",stock:true},
  {id:58,name:"Hongos Adaptógenos (60 caps)",price:27390,cost:20593.98,desc:"Blend de hongos medicinales adaptógenos.",cat:"Estrés & Sueño",barcode:"0714604143253",img:"",stock:true},
  {id:59,name:"INOSITOL - Vitamina B8 (30 caps)",price:17490,cost:13150.38,desc:"Equilibrio hormonal. SOP, ansiedad y metabolismo.",cat:"Hormonal",barcode:"0714604143260",img:"",stock:true},
  {id:106,name:"Inulina - Prebiótico Natural (60 caps)",price:24090,cost:18112.78,desc:"Prebióticos avanzados para microbiota saludable.",cat:"Salud Intestinal",barcode:"0714604213581",img:"/fotos/prebiotico.jpg",stock:true},
  {id:61,name:"Kardio 3 (60 caps)",price:18590,cost:13977.44,desc:"Soporte cardiovascular con Omega 3 y CoQ10.",cat:"Cardiovascular",barcode:"0714604143284",img:"",stock:true},
  {id:68,name:"Lady Balance (60 caps)",price:20790,cost:15631.58,desc:"Equilibrio hormonal femenino. PMS y menopausia.",cat:"Hormonal",barcode:"0714604143307",img:"",stock:true},
  {id:71,name:"Levadura de Selenio (60 caps)",price:18590,cost:13977.44,desc:"Selenio orgánico. Antioxidante y función tiroidea.",cat:"Minerales",barcode:"0714604143345",img:"",stock:true},
  {id:72,name:"L-Glicina (60 caps)",price:17490,cost:13150.38,desc:"Aminoácido esencial para colágeno y proteínas.",cat:"Antiage & Piel",barcode:"0714604213475",img:"",stock:true},
  {id:73,name:"L-Glutamina (90 caps)",price:17490,cost:13150.38,desc:"Recuperación muscular y salud intestinal.",cat:"Deportivo",barcode:"0714604143352",img:"",stock:true},
  {id:74,name:"L-Lisina 500mg (60 caps)",price:17490,cost:13150.38,desc:"Aminoácido esencial. Colágeno y sistema inmune.",cat:"Antiage & Piel",barcode:"0714604143369",img:"",stock:true},
  {id:137,name:"L-Teanina (60 caps)",price:27390,cost:20593.98,desc:"Relaja sin somnolencia. Estrés e insomnio.",cat:"Estrés & Sueño",barcode:"0714604213642",img:"",stock:true},
  {id:75,name:"Maca Peruana Pura 500mg (60 caps)",price:19690,cost:14804.51,desc:"Energizante y estimulante natural. Libido y vitalidad.",cat:"Hormonal",barcode:"0714604213253",img:"",stock:true},
  {id:77,name:"Magnesio Quelatado 400mg (60 caps)",price:16280,cost:12240.60,desc:"Magnesio quelatado de alta absorción.",cat:"Magnesio",barcode:"0714604143383",img:"",stock:true},
  {id:78,name:"Maitake Hongo (60 caps)",price:25190,cost:18939.85,desc:"Hongo medicinal. Estrés e inmunidad.",cat:"Hongos Medicinales",barcode:"0714604213604",img:"",stock:true},
  {id:80,name:"Malato de Magnesio (60 comp)",price:15950,cost:11992.48,desc:"Energía y recuperación muscular.",cat:"Magnesio",barcode:"0714604213383",img:"",stock:true},
  {id:79,name:"Malato de Magnesio 500mg (60 caps)",price:17490,cost:13150.38,desc:"Energía y recuperación muscular.",cat:"Magnesio",barcode:"0714604213277",img:"",stock:true},
  {id:81,name:"Mega D - Hongo Cándida (60 caps)",price:20130,cost:15135.34,desc:"Detox profundo. Control de cándida y hongos.",cat:"Salud Intestinal",barcode:"0714604143390",img:"",stock:true},
  {id:83,name:"Melena de León 500mg (60 caps)",price:30690,cost:23075.19,desc:"Hongo neuroprotector. Cognición y digestión.",cat:"Hongos Medicinales",barcode:"0714604213260",img:"",stock:true},
  {id:85,name:"Moringa (60 caps)",price:17050,cost:12819.55,desc:"Superalimento. Calcio vegetal y antioxidantes.",cat:"Superfoods",barcode:"0714604213536",img:"/fotos/moringa.jpg",stock:true},
  {id:84,name:"MSM 500mg (60 caps)",price:19690,cost:14804.51,desc:"Azufre orgánico. Articulaciones y piel.",cat:"Antiinflamatorio",barcode:"0714604143413",img:"/fotos/msm.jpg",stock:true},
  {id:86,name:"Mucline - Intestino Permeable (60 caps)",price:18590,cost:13977.44,desc:"Optimizador de mucosas e intestino permeable.",cat:"Salud Intestinal",barcode:"0714604143420",img:"/fotos/mucline.jpg",stock:true},
  {id:87,name:"Multi Magnesio 5 en 1 (60 caps)",price:19690,cost:14804.51,desc:"5 formas de magnesio en una sola cápsula.",cat:"Magnesio",barcode:"0714604143758",img:"/fotos/multimagnesio.jpg",stock:true},
  {id:88,name:"Multi Magnesio 5 en 1 (60 comp)",price:18590,cost:13977.44,desc:"5 formas de magnesio en un solo comprimido.",cat:"Magnesio",barcode:"0714604213451",img:"/fotos/multimagnesio-comp.jpg",stock:true},
  {id:89,name:"NAC 500mg (60 caps)",price:25190,cost:18939.85,desc:"N-Acetilcisteína. Optimizador respiratorio.",cat:"Antioxidantes",barcode:"0714604143437",img:"/fotos/nac.jpg",stock:true},
  {id:90,name:"NAD - Longevidad (60 caps)",price:40590,cost:30518.80,desc:"Nicotinamida Adenina Dinucleótido. Energía celular.",cat:"Longevidad",barcode:"0714604143444",img:"/fotos/nad.jpg",stock:true},
  {id:91,name:"NAD - Longevidad (60 comp)",price:39490,cost:29691.73,desc:"Nicotinamida Adenina Dinucleótido. Energía celular.",cat:"Longevidad",barcode:"0714604213499",img:"/fotos/nad-comp.jpg",stock:true},
  {id:93,name:"NAD con Resveratrol 2 en 1 (60 caps)",price:48950,cost:36804.51,desc:"Regenerador celular premium. Longevidad máxima.",cat:"Longevidad",barcode:"0714604213314",img:"/fotos/nad-resveratrol.jpg",stock:true},
  {id:95,name:"NMN (60 caps)",price:40590,cost:30518.80,desc:"Precursor NAD+. El suplemento de longevidad más avanzado.",cat:"Longevidad",barcode:"0714604143833",img:"/fotos/nmn.jpg",stock:true},
  {id:96,name:"NMN (60 comp)",price:38390,cost:28864.66,desc:"Precursor NAD+. Longevidad celular avanzada.",cat:"Longevidad",barcode:"0714604213505",img:"/fotos/nmn-comp.jpg",stock:true},
  {id:160,name:"NMN con Resveratrol (60 caps)",price:47190,cost:35481.20,desc:"NMN + Resveratrol. Longevidad y regeneración celular.",cat:"Longevidad",barcode:"0714604213826",img:"",stock:true},
  {id:97,name:"Omega 3 (60 caps)",price:27489,cost:20668.42,desc:"Ácidos grasos esenciales EPA y DHA. Corazón y cerebro.",cat:"Cardiovascular",barcode:"0714604143468",img:"/fotos/omega3.jpg",stock:true},
  {id:99,name:"ORMUX - Regenerador Celular (60 caps)",price:41030,cost:30849.62,desc:"Suplemento regenerador celular de alta gama.",cat:"Longevidad",barcode:"0714604143482",img:"/fotos/ormux.jpg",stock:true},
  {id:102,name:"Óxido Nítrico (60 caps)",price:17490,cost:13150.38,desc:"Vasodilatador natural. Rendimiento y flujo sanguíneo.",cat:"Deportivo",barcode:"0714604143512",img:"/fotos/oxido-nitrico.jpg",stock:true},
  {id:103,name:"Picolinato de Cromo 250mcg",price:19690,cost:14804.51,desc:"Control glucémico y de peso. Regula el apetito.",cat:"Control de Peso",barcode:"0714604143826",img:"/fotos/picolinato.jpg",stock:true},
  {id:105,name:"Potasio + Magnesio 500mg (60 caps)",price:19250,cost:14473.68,desc:"Electrolitos esenciales para corazón y músculos.",cat:"Minerales",barcode:"0714604213246",img:"/fotos/potasio-magnesio.jpg",stock:true},
  {id:108,name:"Reishi Hongo (60 caps)",price:27390,cost:20593.98,desc:"Hongo rey. Inmunidad, estrés y vitalidad.",cat:"Hongos Medicinales",barcode:"0714604213598",img:"",stock:true},
  {id:109,name:"Resveratrol Antioxidante (60 caps)",price:24750,cost:18609.02,desc:"Rejuvenecedor celular. Antioxidante de vid.",cat:"Antioxidantes",barcode:"0714604143536",img:"",stock:true},
  {id:110,name:"Resveratrol Antioxidante (60 comp)",price:22990,cost:17285.71,desc:"Rejuvenecedor celular. Antioxidante de vid.",cat:"Antioxidantes",barcode:"0714604213369",img:"",stock:true},
  {id:111,name:"Sinefrina - Quemador Natural (60 caps)",price:25190,cost:18939.85,desc:"Termogénico natural. Quema grasa sin estimulantes.",cat:"Control de Peso",barcode:"0714604143741",img:"",stock:true},
  {id:112,name:"Sinefrina - Quemador Natural (60 comp)",price:22550,cost:16954.89,desc:"Termogénico natural. Quema grasa sin estimulantes.",cat:"Control de Peso",barcode:"0714604213352",img:"",stock:true},
  {id:114,name:"Spirulina Pura 500mg (60 caps)",price:16390,cost:12323.31,desc:"Superalimento marino. Pérdida de peso y antioxidante.",cat:"Superfoods",barcode:"0714604213284",img:"",stock:true},
  {id:115,name:"Taurato de Magnesio 500mg (60 caps)",price:19690,cost:14804.51,desc:"Magnesio cardioprotector. Corazón y sistema nervioso.",cat:"Magnesio",barcode:"0714604143550",img:"",stock:true},
  {id:116,name:"Taurato de Magnesio (60 comp)",price:17589,cost:13224.81,desc:"Magnesio cardioprotector.",cat:"Magnesio",barcode:"0714604213543",img:"",stock:true},
  {id:117,name:"Testo Up (60 caps)",price:22990,cost:17285.71,desc:"Precursor de testosterona natural. Energía y músculo.",cat:"Hormonal",barcode:"0714604143567",img:"",stock:true},
  {id:138,name:"Testo Up (60 comp)",price:21890,cost:16458.65,desc:"Precursor de testosterona natural.",cat:"Hormonal",barcode:"0714604213741",img:"",stock:true},
  {id:118,name:"Tirosina + Yodo (60 caps)",price:17490,cost:13150.38,desc:"Soporte tiroideo. Metabolismo y energía.",cat:"Tiroides",barcode:"0714604213635",img:"",stock:true},
  {id:119,name:"Treonato de Magnesio 500mg (60 caps)",price:21890,cost:16458.65,desc:"Magnesio cerebral. Memoria y neuroprotección.",cat:"Magnesio",barcode:"0714604143581",img:"",stock:true},
  {id:120,name:"Treonato de Magnesio (60 comp)",price:20790,cost:15631.58,desc:"Magnesio cerebral. Memoria y neuroprotección.",cat:"Magnesio",barcode:"0714604213376",img:"",stock:true},
  {id:121,name:"Triptófano (60 caps)",price:17490,cost:13150.38,desc:"Precursor de serotonina. Sueño, calma y buen humor.",cat:"Estrés & Sueño",barcode:"0714604213437",img:"",stock:true},
  {id:123,name:"Vitamina A Retinol 1000mcg (30 caps)",price:20350,cost:15300.75,desc:"Visión, piel e inmunidad.",cat:"Vitaminas",barcode:"0714604143819",img:"",stock:true},
  {id:124,name:"Vitamina B12 (60 caps)",price:16390,cost:12323.31,desc:"Equilibrio sanguíneo y neurológico. Energía.",cat:"Vitaminas",barcode:"0714604143604",img:"",stock:true},
  {id:125,name:"Vitamina C 500mg (60 caps)",price:13090,cost:9842.11,desc:"Ácido ascórbico puro. Inmunidad y antioxidante.",cat:"Vitaminas",barcode:"0714604143611",img:"",stock:true},
  {id:139,name:"Vitamina C 500mg (60 comp)",price:12650,cost:9511.28,desc:"Ácido ascórbico puro. Inmunidad y antioxidante.",cat:"Vitaminas",barcode:"0714604213758",img:"",stock:true},
  {id:126,name:"Vitamina D3 + K2 (60 caps)",price:19690,cost:14804.51,desc:"Salud ósea y cardiovascular. Dupla perfecta.",cat:"Vitaminas",barcode:"0714604143659",img:"",stock:true},
  {id:127,name:"Vitamina D3 + K2 (60 comp)",price:18590,cost:13977.44,desc:"Salud ósea y cardiovascular.",cat:"Vitaminas",barcode:"0714604213512",img:"",stock:true},
  {id:128,name:"Vitamina D3 20mcg (30 caps)",price:14190,cost:10669.17,desc:"Huesos, músculos y sistema nervioso.",cat:"Vitaminas",barcode:"0714604143642",img:"",stock:true},
  ...
  {id:152,name:"Whey Protein + Glutamina y BCAA Americana (1 kg)",price:68090,cost:51195.49,desc:"Proteína completa con recuperadores musculares.",cat:"Proteínas",barcode:"0714604213680",img:"",stock:true},
  {id:151,name:"Whey Protein + Glutamina y BCAA Chocolate (1 kg)",price:68090,cost:51195.49,desc:"Proteína completa con recuperadores musculares.",cat:"Proteínas",barcode:"0714604143697",img:"",stock:true},
  {id:153,name:"Whey Protein + Glutamina y BCAA Frambuesa (1 kg)",price:68090,cost:51195.49,desc:"Proteína completa con recuperadores musculares.",cat:"Proteínas",barcode:"0714604213673",img:"",stock:true},
  ...
  {id:144,name:"Whey Protein 80% Americana (1 kg)",price:65890,cost:49541.35,desc:"Proteína de suero de alta calidad. Sabor americana.",cat:"Proteínas",barcode:"0714604213734",img:"",stock:true},
  {id:143,name:"Whey Protein 80% Chocolate (1 kg)",price:65890,cost:49541.35,desc:"Proteína de suero de alta calidad. Sabor chocolate.",cat:"Proteínas",barcode:"0714604213710",img:"",stock:true},
  {id:145,name:"Whey Protein 80% Frambuesa (1 kg)",price:65890,cost:49541.35,desc:"Proteína de suero de alta calidad. Sabor frambuesa.",cat:"Proteínas",barcode:"0714604213727",img:"",stock:true},
  {id:136,name:"ZMA Zinc-Magnesio-B6 (60 caps)",price:16390,cost:12323.31,desc:"Recuperación nocturna. Testosterona y sueño profundo.",cat:"Deportivo",barcode:"0714604143727",img:"",stock:true},
  {id:157,name:"Kit Active Vital - Óxido Nítrico + NAD + BCAA",price:71250,cost:53571.43,desc:"Kit energía y rendimiento. 3 productos de alta rotación.",cat:"Kits",barcode:"KIT-ACTIVE",isKit:true,img:"",stock:true},
  {id:159,name:"Kit Daily Energy - Cúrcuma + NAD + Malato Mg",price:71250,cost:53571.43,desc:"Kit energía diaria.",cat:"Kits",barcode:"KIT-DAILY",isKit:true,img:"",stock:true},
  {id:66,name:"Kit Hongo Cándida (180 caps)",price:48290,cost:36308.27,desc:"Protocolo completo antifúngico.",cat:"Kits",barcode:"KIT-CANDIDA",isKit:true,img:"",stock:true},
  {id:158,name:"Kit Skin Balance - Omega 3 + CoQ10 + Centella",price:73340,cost:55142.86,desc:"Kit salud de la piel.",cat:"Kits",barcode:"KIT-SKIN",isKit:true,img:"",stock:true},
  {id:92,name:"Kit NAD + Resveratrol Antiage (120 caps)",price:59290,cost:44578.95,desc:"El kit de longevidad más vendido.",cat:"Kits",barcode:"KIT-NAD",isKit:true,img:"",stock:true},
];

const KITS_ROTACION=[
  {id:"k1",name:"Kit Arranque Dietética",subtitle:"Ideal para dietéticas y herboristerías",products:["Vitamina C 500mg","Vitamina D3 + K2","Omega 3","Magnesio Quelatado 400mg","Spirulina Pura 500mg"],investment:"~$88.000 mayorista",ganancia:"~$117.000 PVP",margen:"33%",icon:"🌿",nicho:"Dietéticas"},
  {id:"k2",name:"Kit Rendimiento Gym",subtitle:"Para gimnasios y entrenadores",products:["Creatina Pura 100% (300gr)","BCAA Aminoácidos Esenciales","L-Glutamina","ZMA Zinc-Magnesio-B6","Óxido Nítrico"],investment:"~$92.000 mayorista",ganancia:"~$122.000 PVP",margen:"33%",icon:"💪",nicho:"Gimnasios"},
  {id:"k3",name:"Kit Bienestar Profesional",subtitle:"Para nutricionistas y médicos",products:["Ashwagandha 100% Pura","Multi Magnesio 5 en 1","Inulina Prebiótico","Ginkgo Biloba","Triptófano"],investment:"~$95.000 mayorista",ganancia:"~$126.000 PVP",margen:"33%",icon:"🩺",nicho:"Profesionales"},
  {id:"k4",name:"Kit Longevidad Premium",subtitle:"Alta rentabilidad, nicho en crecimiento",products:["NMN","NAD con Resveratrol 2 en 1","Glutatión Antioxidante","Astaxantina 10mg","Coenzima Q10 300mg"],investment:"~$145.000 mayorista",ganancia:"~$193.000 PVP",margen:"33%",icon:"⚡",nicho:"Longevidad"},
  {id:"k5",name:"Kit Hormonal Mujer",subtitle:"Emprendedoras y consultas femeninas",products:["Lady Balance","INOSITOL Vitamina B8","Maca Peruana 500mg","Ácido Fólico","Centella Asiática"],investment:"~$80.000 mayorista",ganancia:"~$107.000 PVP",margen:"33%",icon:"🌸",nicho:"Emprendedoras"},
  {id:"k6",name:"Kit Control de Peso",subtitle:"Alta rotación todo el año",products:["Garcinia Cambogia","Sinefrina Quemador Natural","Picolinato de Cromo","Fucus Plus","Cafeína + Guaraná"],investment:"~$77.000 mayorista",ganancia:"~$103.000 PVP",margen:"33%",icon:"🔥",nicho:"Control Peso"},
];
...
export default function App(){
  ...
  const filtered=useMemo(()=>{
    ...
    return products.filter(p=>{
      ...
      const matchSearch=!q||p.name.toLowerCase().includes(q)||(p.desc&&p.desc.toLowerCase().includes(q))||(p.barcode&&p.barcode.includes(q))||p.cat.toLowerCase().includes(q);
  ...
  function saveNew(){if(!newP.name||!newP.price)return;setProducts(p=>[...p,{...newP,id:Date.now(),price:Number(newP.price),cost:Number(newP.cost)||0,stock:true}]);setNewP({name:"",price:"",cost:"",desc:"",cat:"",stock:99,barcode:""});setImgPrev("");}
  ...
  const S={
    ...
    cardBtn:(s)=>({background:s===false?"#ccc":blue,color:white,border:"none",borderRadius:12,padding:"9px 0",cursor:s===false?"not-allowed":"pointer",fontSize:13,fontWeight:600,width:"100%",marginTop:10,opacity:s===false?0.5:1}),
          ...
          {KITS_ROTACION.map(k=>(
            <div key={k.id} style={{background:white,borderRadius:18,padding:24,boxShadow:"0 2px 10px rgba(0,0,0,0.07)",border:`1px solid ${lightBlue}`}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,textAlign:"center"}}>
                ...
                <div style={{background:"#d1fae5",borderRadius:10,padding:"8px 4px"}}><div style={{fontSize:10,color:"#065f46",fontWeight:600,textTransform:"uppercase"}}>Venta PVP</div><div style={{fontSize:11,fontWeight:800,color:"#065f46",marginTop:2}}>{k.ganancia}</div></div>
                <div style={{background:lightBlue,borderRadius:10,padding:"8px 4px"}}><div style={{fontSize:10,color:darkBlue,fontWeight:600,textTransform:"uppercase"}}>Margen</div><div style={{fontSize:22,fontWeight:800,color:blue,marginTop:2,lineHeight:1}}>{k.margen}</div></div>
              </div>
  ...
  const Store=()=>(
    <div style={S.section}>
      <div style={{marginBottom:16}}>
        ...
        <div style={{color:gray,fontSize:14,marginBottom:16}}>{filtered.length} de {products.length} productos · Stock inmediato</div>
        <input style={S.searchBox} placeholder="🔍 Buscar por nombre, descripción o código de barras..." value={search} onChange={e=>setSearch(e.target.value)}/>
        <div style={S.filters}>
          {CATEGORIES.map(c=><button key={c} style={S.filterBtn(cat===c)} onClick={()=>setCat(c)}>{c}</button>)}
        </div>
      </div>
      {filtered.length===0
        ?<div style={{textAlign:"center",color:gray,padding:"40px 0",fontSize:15}}>No se encontraron productos.</div>
        :<>
          <div style={S.grid}>
            {paginados.map(p=>(
          ...
          {products.map(p=>(
            <div key={p.id} style={{display:"flex",gap:12,alignItems:"center",padding:"12px 0",borderBottom:"1px solid #f5f5f7"}}>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{fontSize:11,color:gray}}>{p.cat} · {fmt(p.price)} · {p.stock===false?"❌ Sin stock":"✅ En stock"}</div>
              </div>
